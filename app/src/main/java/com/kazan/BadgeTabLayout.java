...
public class BadgeTabLayout extends TabLayout {
  private final SparseArray<Builder> mTabBuilders = new SparseArray<Builder>();
  ...
  public static final class Builder {
     ...
     * @param tab
     */
    private Builder(TabLayout parent, @NonNull Tab tab) {
      super();
  ...
  @SuppressLint("NewApi") private static Drawable getDrawableCompat(Context context, int drawableRes) {
