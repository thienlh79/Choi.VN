...
public class MissionItem implements ChoiItem {
    ...
    public void setView(View view) {
        ...
        String missionCount = "";//context.getString(R.string.game_download) + ": " + (new Random().nextInt(1000000) + 1000);

        switch (type) {
            default:
            case 0:
                //missionType = MissionType.DOWNLOAD;
                typeString = context.getString(R.string.mission_type_install);
                missionCount = context.getString(R.string.mission_install_count);
                break;
            case 1:
                //missionType = MissionType.SHARE;
                typeString = context.getString(R.string.mission_type_share);
                downloadedCount = context.getString(R.string.mission_share_count);
                break;
            case 2:
                //missionType = MissionType.LIKE;
                typeString = context.getString(R.string.mission_type_like);
                missionCount = context.getString(R.string.mission_like_count);
                break;
        }
        typeString = context.getString(R.string.mission_type) + ": " + typeString;
        missionCount = missionCount + ": " + (new Random().nextInt(1000000) + 1000);
        ...
        String missionPoint = context.getString(R.string.mission_point) + ": " + getUnknowMessage(context, point) + context.getString(R.string.game_coin);
        ...
        TypefaceUtil.setText(AppsUtils.getView(view, R.id.game_item_download_text), missionCount);
        TypefaceUtil.setTextBold(AppsUtils.getView(view, R.id.game_item_action), actionString);
        TypefaceUtil.setText(AppsUtils.getView(view, R.id.game_item_size), missionPoint);
        ...
        TypefaceUtil.setText(actionView, context.getString(R.string.message_get_giftcode));
    ...
    private void loginAndTakeMission() {
		...
		new VggSdkHelper().loginWithFacebook(activity, new VggResultCallback<VggApiObject>() {

			@Override
			public void onResult(VggApiObject result) {
